...
function useFormState(props) {
  ...
  _name.current = name;
  import_react5.default.useEffect(() => control._subscribe({
    name: _name.current,
  ...
  return import_react5.default.useMemo(() => getProxyFormState(formState, control, _localProxyFormState.current, false), [formState, control]);
}
...
function useWatch(props) {
  ...
  const _name = import_react5.default.useRef(name);
  const _defaultValue = import_react5.default.useRef(defaultValue);
  _name.current = name;
  import_react5.default.useEffect(() => control._subscribe({
    name: _name.current,
    formState: {
...
function useForm(props = {}) {
  const _formControl = import_react5.default.useRef(void 0);
  const _values = import_react5.default.useRef(void 0);
  ...
  import_react5.default.useLayoutEffect(() => control._subscribe({
    formState: control._proxyFormState,
    callback: () => updateFormState({ ...control._formState }),
    reRenderRoot: true
  }), [control]);
  import_react5.default.useEffect(() => control._disableForm(props.disabled), [control, props.disabled]);
  import_react5.default.useEffect(() => {
...
function useExportControlToExtension({ id, control }) {
  ...
  useDeepCompareEffect(() => {
    ...
    const nativeFields = flatFieldNames.reduce((prev2, name) => {
      ...
      prev2[name] = (_b = (0, import_get.default)(field, "ref")) === null || _b === void 0 ? void 0 : _b.type;
      return prev2;
    }, {});
